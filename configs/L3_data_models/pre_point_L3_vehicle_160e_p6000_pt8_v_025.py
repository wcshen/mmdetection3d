...
model = dict(
    ...
    voxel_encoder=dict(
        ...
        point_cloud_range=point_cloud_range),
    middle_encoder=dict(
        type='FusePointPillarsScatter', in_channels=64*2, output_shape=[80, 400]),
    backbone=dict(
        type='SECOND',
        in_channels=64,
        layer_nums=[3, 5, 5],
...
l3_data_root = '/home/wancheng.shen/datasets/L4E_origin_data/'
l3_benchmark_root = '/home/wancheng.shen/datasets/L4E_origin_benchmark/'
