...
use_sync_bn=False
extra_tag = 'single_head_sync_bn_w_xyz_1.3'
# model settings
voxel_size = [0.25, 0.1, 8]
...
model = dict(
    ...
    voxel_layer=dict(
        ...
        max_voxels=(15000, 15000)  # (training, testing) max_voxels
    ),
    voxel_encoder=dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            sizes=[[4.63, 1.97, 1.74], # car
                   [12.5, 2.94, 3.47], # truck1
                   [24.0, 2.94, 3.47], # truck2
                   ],
            rotations=[0, 1.57],
            reshape_out=False),
