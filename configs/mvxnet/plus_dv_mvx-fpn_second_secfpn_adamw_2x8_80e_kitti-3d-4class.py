...
train_pipeline = [
    dict(type='LoadPointsFromFile', coord_type='LIDAR', load_dim=4, use_dim=4, point_type='float64'),
    ...
    # dict(type='RandomFlip3D', flip_ratio_bev_horizontal=0.5), # including image flip
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'L4_data_infos_val.pkl',
        split='training',
