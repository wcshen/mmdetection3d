...
train_pipeline = [
    ...
    dict(type='GetGtMasks', point_cloud_range=point_cloud_range, voxel_size=voxel_size, downsample_ratio=2),
    dict(type='PointShuffle'),
    dict(type='DefaultFormatBundle3D', class_names=class_names),
    dict(type='Collect3D', keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_masks'])
]
