...
l4_benchmark_root = '/mnt/intel/jupyterhub/swc/datasets/L4_extracted_data/CN_L4_origin_benchmark/'
...
db_sampler = dict(
    ...
    info_path=l4_data_root + 'Kitti_L4_data_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        data_root=l4_data_root,
        ann_file=l4_data_root + 'Kitti_L4_data_mm3d_infos_val.pkl',
    ...
    test=dict(
        type=dataset_type,
        data_root=l4_benchmark_root,
        ann_file=l4_benchmark_root + 'Kitti_L4_data_mm3d_infos_val.pkl',
